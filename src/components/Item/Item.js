...
const Item = ({item, children, onItemDelete, isCartPage, onAction}) => {
  ...
  return (
    <div className={`h-auto w-full p-4 flex flex-col justify-end border-b border-gray-300`}>
      <div className={`text-right`}><span onClick={isCartPage ? onAction : onItemDelete} className={`px-2 py-1 border border-red-300 hover:bg-red-300 cursor-pointer`}>x</span></div>
